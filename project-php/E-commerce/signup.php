   ...
   <form action="includes/signup.inc.php" method="post"> <br>
      ...
      <div class="div-sign">
         ...
         if (isset($_GET['error'])) {
            switch ($_GET['error']) {
               case '!loggedin':
                  echo '<br> <br><div class="alert alert-danger">Signup or Login first.</div>';
                  break;
               case 'enterValidNumber':
                  echo '<br> <br><div class="alert alert-danger">Enter valid number.</div>';
                  break;
               case 'invalidemail':
                  echo '<br> <br><div class="alert alert-danger">Enter valid email address.</div>';
                  break;
               case 'pwdnotmatch':
                  echo '<br> <br><div class="alert alert-danger">Entered password does not matched.</div>';
                  break;
               case 'emptyInput':
                  echo '<br> <br><div class="alert alert-danger">Form must be filled.</div>';
                  break;
               case 'emailAlreadytaken':
                  echo '<br> <br><div class="alert alert-danger">Account is already registered with this email.</div>';
                  break;
            }
         }
