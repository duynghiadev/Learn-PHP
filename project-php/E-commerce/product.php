  ...
  <div class="selected_product">
    <div class="prod-in">
      ...
      <div class="detail-cont-pr">
        <h5 class="title"><?php echo $row11['product_title'] ?> <p class="date"><?php echo $row11['product_date'] ?></p>
        </h5>
        ...
        <form action="<?php echo $_SERVER['PHP_SELF']; ?> " method="post">
          ...
          <div class="btn-pr">
            <a href="payment.php?id=<?php echo $_GET['id'] ?>" style='text-decoration:none'>
              <p class="button btn1">Purchase</p>
            </a>
