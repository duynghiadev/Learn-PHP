...
<body onload="loading()">
  ...
  <div class="menu">
    <section class="list">
      ...
      <?php
            ...
            ?>
      <a href="#<?php echo $categoryData['CATEGORY']; ?>" class="listlink linklistActive"
        id="list_<?php echo $categoryData['CATEGORY']; ?>"
        onclick="activeLink('list_<?php echo $categoryData['CATEGORY']; ?>')">
    ...
    <section class="items">
      ...
      <?php
            ...
            while ($categoryData = $result->fetch_array(MYSQLI_ASSOC)) {
            ?>
      <p class="categoryHeading" id="<?php echo $categoryData['CATEGORY']; ?>">
        <?php echo $categoryData['CATEGORY']; ?></p>
      ...
      <div class="menuItem">
        ...
        <div class="food">
          <?php
                            ...
                            ?>
          <img src="<?php echo "../source/menu_image/" . $itemData['IMAGE']; ?>" alt="IMG"
            class="foodimg">
          <?php
                            } else {
                            ?>
          ...
          <div class="fooddetail">
            ...
            <div class="addOption">
              <?php
                                    ...
                                    ?>
              <button class="addBtn1" id="addBtn<?php echo $a; ?>"
                onclick="showElement('add-outer<?php echo $a; ?>')">ADD</button>
              <?php
                                    }
                                    ?>
            </div>
            ...
            <div id="add-outer<?php echo $a; ?>" class="add-outer">
              <div class="add-card">
                <img src="<?php echo "../source/menu_image/" . $itemData['IMAGE']; ?>" alt=""
                  class="add-card-food-image">
                <form method="post" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>"
                  enctype="multipart/form-data" class="addForm">
                  <div class="card-food-detail">
                    <p class="card-food-name"><?php echo $itemData['ITEM_NAME']; ?></p>
                    <p class="price"><?php echo $itemData['PRICE']; ?> &#8377;</p>
                  </div>
                  <div class="quantityBtns">
                    <div class="addingBtn" onclick="minusIncrese('itemCount<?php echo $a; ?>')">–
                    </div>
                    <input type="number" name="itemQuantity<?php echo $a; ?>" value=1
                      id="itemCount<?php echo $a; ?>">
                    <div class="addingBtn" onclick="addIncrese('itemCount<?php echo $a; ?>')">+
                    </div>
                  </div>
                  <div class="submitBtns">
                    <div class="add-outer-close"
                      onclick="hideElement('add-outer<?php echo $a; ?>')">×</div>
                    <button type="submit" class="addingBtn addBtn2"
                      name="addToCartBtn<?php echo $a; ?>">ADD TO ORDER</button>
                  </div>
                </form>
              </div>
            </div>
          ...
          <div>
            ...
            <div class="cartListPrice">
              ...
              <?php
                                    ...
                                    ?>
              <a
                href="removeFromCart.php?orderNo=<?php echo $cartData['ORDER_NO']; ?>&tableNo=<?php echo $cartData['TABLE_NO']; ?>&itemName=<?php echo $cartData['ITEM_NAME']; ?>&quantity=<?php echo $cartData['QUANTITY']; ?>&bilNo=<?php echo $billNo;?>">
                <?php
      ...
      <div id="cartLine">
        ...
        <div>
          ...
          <a href="order.php?tableNo=<?php echo $tableNo; ?>&billNo=<?php echo $billNo; ?>"
            class="continueBtn">Order</a>
        </div>
      </div>
      <?php
            }
  ...
  function addIncrese(itemCountId) {
    document.getElementById(itemCountId).value = Number(document.getElementById(itemCountId)
      .value) + 1;
  }
