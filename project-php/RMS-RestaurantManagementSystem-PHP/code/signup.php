      ...
      <form name="RegForm" method="post"
        ...
        <div class="side">
          <div class="form-floating mb-3">
            <input type="text" pattern="[A-Z, a-z]*" class="form-control shadow-none" id="firstname"
              name="fname" placeholder="First Name" required>
            <label for="firstname">First Name</label>
          </div>
          <div class="form-floating mb-3">
            <input type="text" pattern="[A-Z, a-z]*" class="form-control shadow-none" id="lastname"
              name="lname" placeholder="Last Name" required>
            <label for="lastname">Last Name</label>
          </div>
        </div>
        <div class="form-floating mb-3">
          <input type="tel" pattern="[[0-9]{10}]*" maxlength="10" class="form-control shadow-none"
            id="number" name="phone" placeholder="Mobile Number" required>
        ...
        <div class="form-floating mb-3">
          <input type="password" class="form-control shadow-none" id="password" name="pass"
            placeholder="Password" required>
          <label for="password">Password</label>
        </div>
        <div class="form-floating mb-2">
          <input type="password" class="form-control shadow-none" id="confirm_pass" name="copass"
