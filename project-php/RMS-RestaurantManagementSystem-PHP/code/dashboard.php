...
<body onload="loading()">
  ...
  <div class="sidebar">
    ...
    <ul class="nav-list">
      <li>
        <a href="#" class="sidebarLink sidebarLinkActive" id="text_dashboard"
          onclick="activeTab(event, 'dashboard', 'link_dashboard', 'text_dashboard')">
      ...
      <?php
            ...
            ?>
      <li>
        <a href="#" class="sidebarLink" id="text_order"
          onclick="activeTab(event, 'order', 'link_order', 'text_order')">
      ...
      <?php
            ...
            ?>
      <li>
        <a href="#" class="sidebarLink" id="text_orders"
          onclick="activeTab(event,'orders', 'link_orders', 'text_orders')">
      ...
      <?php
            ...
            ?>
      <li>
        <a href="#" class="sidebarLink" id="text_orderlist"
          onclick="activeTab(event,'orderlist', 'link_orderlist', 'text_orderlist')">
      ...
      <?php
            ...
            ?>
      <li>
        <a href="#" class="sidebarLink" id="text_updatemenu"
          onclick="activeTab(event,'updatemenu', 'link_updatemenu', 'text_updatemenu')">
      ...
      <?php
            ...
            ?>
      <li>
        <a href="#" class="sidebarLink" id="text_bill"
          onclick="activeTab(event, 'bill', 'link_bill', 'text_bill')">
      ...
      <?php
            ...
            ?>
      <li>
        <a href="#" class="sidebarLink" id="text_staff"
          onclick="activeTab(event, 'staff', 'link_staff', 'text_staff')">
      ...
      <?php
            ...
            ?>
      <li>
        <a href="#" class="sidebarLink" id="text_setting"
          onclick="activeTab(event , 'setting', 'link_setting', 'text_setting')">
  ...
  <section class="home-section">
    ...
    <div id="order" class="tab">
      ...
      <div class="table-map-outer">
        <?php
                ...
                while ($dataTables = $resultTables->fetch_array(MYSQLI_ASSOC)) {
                ?>
        <a href="menu.php?tableNo=<?php echo $dataTables['TABLE_NO']; ?>"
          class="table-box <?php if (!$dataTables['TABLE_STATUS']) {
                                                                                                            echo "occupy";
            ...
            <tr>
              ...
              <td>
                <?php
                                    if ($dataOrder['STATUS'] == 1) {
                                    ?>
                <a href="cook.php?orderNo=<?php echo $dataOrder['ORDER_NO']; ?>&tableNo=<?php echo $dataOrder['TABLE_NO']; ?>&itmeName=<?php echo $dataOrder['ITEM_NAME']; ?>&quantity=<?php echo $dataOrder['QUANTITY']; ?>"
                  class="cookBtn">Cook</a>
                <?php
                                    } else if ($dataOrder['STATUS'] == 2) {
                                    ?>
                <a href="ready.php?orderNo=<?php echo $dataOrder['ORDER_NO']; ?>&tableNo=<?php echo $dataOrder['TABLE_NO']; ?>&itmeName=<?php echo $dataOrder['ITEM_NAME']; ?>&quantity=<?php echo $dataOrder['QUANTITY']; ?>"
                  class="cookBtn readyBtn">Ready</a>
                <?php
                                    }
                                    ?>
              </td>
            ...
            <tr>
              ...
              <td>
                <?php
                                    ...
                                    ?>
                <a href="serve.php?orderNo=<?php echo $dataOrder['ORDER_NO']; ?>&tableNo=<?php echo $dataOrder['TABLE_NO']; ?>&itmeName=<?php echo $dataOrder['ITEM_NAME']; ?>&quantity=<?php echo $dataOrder['QUANTITY']; ?>"
                  class="cookBtn">Served</a>
                <?php
                                    }
                                    ?>
              </td>
      ...
      <div class="outer outer-menu">
        <table class="staffTable" cellspacing="0">
          ...
          <tbody>
            ...
            <tr>
              <td><?php echo $i; ?></td>
              <td><img class="menu-item-photo"
                  src="<?php echo "../source/menu_image/" . $dataMenu['IMAGE']; ?>"></td>
              ...
              <?php
                                ...
                                ?>
              <td><a onclick="showElement('editItemFormOuter<?php echo $i; ?>')" class="editBtn"><i
                    class='bx bx-pencil'></i></a></td>
              <td><a
                  href="removeMenuItem.php?itemName=<?php echo $dataMenu['ITEM_NAME']; ?>&price=<?php echo $dataMenu['PRICE']; ?>&category=<?php echo $dataMenu['CATEGORY']; ?>"
                  class="removeBtn"><i class='bx bx-trash removeBtn'></i></a></td>
            </tr>
            ...
            <div id="editItemFormOuter<?php echo $i; ?>" class="editItemFormOuter">
              <form method="post" class="editItemForm"
                ...
                <i class='bx bx-x-circle'
                  onclick="hideElement('editItemFormOuter<?php echo $i; ?>')"></i>
                <h2>Edit Item</h2>
                <img class="menu-item-photo"
                  src="<?php echo "../source/menu_image/" . $dataMenu['IMAGE']; ?>">
                <div>
                  <label for="itemName">Item Name</label>
                  <input type="text" name="item_name<?php echo $i; ?>"
                    value="<?php echo $dataMenu['ITEM_NAME']; ?>" id="itemName">
                </div>
                <div>
                  <label for="itemPrice">Price</label>
                  <input type="number" name="price<?php echo $i; ?>"
                    value="<?php echo $dataMenu['PRICE']; ?>" id="itemPrice">
                </div>
                <div>
                ...
                <div>
                  ...
                  <select value="<//?php echo $dataMenu['CATEGORY']; ?>"
                    name="category<?php echo $i; ?>" id="ItemCategory">
                ...
                <button class="editItemBtn" type="submit"
                  name="EditMenuBtn<?php echo $i; ?>">Update</button>
            </div>
            </form>
      ...
      <div class="outer">
        <table class="staffTable" cellspacing="0">
          ...
          <tbody>
            ...
            <tr>
              <td><?php echo $i; ?></td>
              <td><img class="profile_photo"
                  src="<?php echo "../source/profile_photos/" . $dataStaff['PHOTO']; ?>"></td>
              ...
              <td><a
                  href="removeUser.php?fname=<?php echo $dataStaff['FNAME'] ?>&lname=<?php echo $dataStaff['LNAME'] ?>&phone=<?php echo $dataStaff['PHONE']; ?>&email=<?php echo $dataStaff['EMAIL']; ?>"><i
                    class='bx bx-trash removeBtn'></i></a></td>
            </tr>
            <?php
                            $i++;
                        }
          ...
          <tbody>
            ...
            <tr>
              ...
              <?php
                                ...
                                ?>
              <td>
                <p class="bill-status bill-status-completed">
                  <?php echo billStatusToString($dataBill['BILL_STATUS']); ?></p>
              </td>
              <td>
                <p class="generateBill" id="viewBill<?php echo $dataBill['BILL_NO']; ?>"
                  onclick="showElement('bill-outer<?php echo $dataBill['BILL_NO']; ?>')">View Bill
                </p>
              </td>
              <?php
                                } else {
                                ?>
              <td>
                <p class="bill-status bill-status-pending">
                  <?php echo billStatusToString($dataBill['BILL_STATUS']); ?></p>
              </td>
              <td>
                <p class="generateBill" id="viewBill<?php echo $dataBill['BILL_NO']; ?>"
                  onclick="showElement('bill-outer<?php echo $dataBill['BILL_NO']; ?>')">Generate
                  Bill</p>
              </td>
              <?php
                                }
        ...
        <div class="bill-outer" id="bill-outer<?php echo $dataBill['BILL_NO']; ?>">
          <div class="bill">
            <div class="bill-detail">
              ...
              <i class='bx bx-x-circle'
                onclick="hideElement('bill-outer<?php echo $dataBill['BILL_NO']; ?>')"></i>
            </div>
            <?php
            ...
            <div class="bill-btn">
              <?php
                                if (!$dataBill['BILL_STATUS']) {
                                ?>
              <a href="payment.php?billNo=<?php echo $dataBill['BILL_NO']; ?>&tableNo=<?php echo $dataBill['TABLE_NO']; ?>&position=<?php echo $data['FNAME'] . " " . $data['LNAME']; ?>"
                class="paymentBtn">Payment Done</a>
              <?php
                                }
                                ?>
              <p class="closeBtn"
                onclick="hideElement('bill-outer<?php echo $dataBill['BILL_NO']; ?>')">close</p>
            </div>
          </div>
        </div>
        <?php
    ...
    <div id="setting" class="tab">
      ...
      <div class="edit-profile">
        ...
        <form id="profile-form" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>"
      ...
      <div id="changePassOuter">
        <form method="get" id="ChangePassForm"
          action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>"
          enctype="multipart/form-data">
          ...
          <div>
            <input type="password" placeholder="Re-enter password" name="repass" id="repass"
              required>
          </div>
